function setup() {
  ...
  function mouseClicked(){
    ...
    if(mouseX <= 500 && mouseX >= 0 && mouseY <= 500 && mouseY >= 0 ){
      ...
      lineY1 = random(300) + 150;

      lineX2 = random(300) + 150;
      ...
      document.getElementById("mavi-kenar-yarı").innerHTML    = "Mavi    Kenarın Yarı Uzunluğu : "+(calculate_d(lineX2,lineY2,centerX,centerY))/2
    }
}
