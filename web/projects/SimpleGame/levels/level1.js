...
function draw_map_level1(xM,yM) {
    ...
    draw_square(yM  +2    ,xM  +5  )
    isMap[xM+5][yM+2] = true;

    draw_square(yM  +3    ,xM  +5  )
    isMap[xM+5][yM+3] = true;

    draw_square(yM   +4   ,xM  +5  )
    isMap[xM+5][yM+4] = true;

    draw_square(yM  +5    ,xM  +5  )
    isMap[xM+5][yM+5] = true;

    draw_square(yM  +6    ,xM  +5  )
    isMap[xM+5][yM+6] = true;

    draw_square(yM  +6    ,xM  +4  )
    isMap[xM+4][yM+6] = true;

    draw_square(yM  +6    ,xM  +3  )
    isMap[xM+3][yM+6] = true;
    ...
    draw_square(yM  +2    ,xM  +1  )
    isMap[xM+1][yM+2] = true;
    ...
    draw_square(yM  +5    ,xM  +1  )
    isMap[xM+1][yM+5] = true;
