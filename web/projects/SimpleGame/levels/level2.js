...
function draw_map_level2(xM,yM) {

    for(var x = 0; x <=8;x++){
        
        draw_square(yM + x     ,xM +x   )
        isMap[xM+x][yM+x] = true;
        draw_square(yM + x +1    ,xM +x   )
        isMap[xM+x][yM + x +1] = true;
        
    }

    for(var x = 9;x >= 0 ; x--){
        draw_square(yM + 9    ,xM +x   )
        isMap[xM+x][yM+9] = true;
    }

    for(var y = 8;y >= 0 ; y--){
        draw_square(yM + y    ,xM +9   )
        isMap[xM+9][yM+y] = true;
    }
