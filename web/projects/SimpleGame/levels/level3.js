...
function draw_map_level3(xM, yM) {
    ...
    draw_square(yM + 1, xM + 3)
    isMap[xM + 3][yM + 1] = true;

    draw_square(yM + 1, xM + 5)
    isMap[xM + 5][yM + 1] = true;

    draw_square(yM + 1, xM + 6)
    isMap[xM + 6][yM + 1] = true;

    draw_square(yM + 2, xM + 2)
    isMap[xM + 2][yM + 2] = true;

    draw_square(yM + 2, xM + 6)
    isMap[xM + 6][yM + 2] = true;

    draw_square(yM + 2, xM + 7)
    isMap[xM + 7][yM + 2] = true;

    draw_square(yM + 2, xM + 3)
    isMap[xM + 3][yM + 2] = true;

    draw_square(yM + 3, xM + 1)
    isMap[xM + 1][yM + 3] = true;

    draw_square(yM + 3, xM + 2)
    isMap[xM + 2][yM + 3] = true;

    draw_square(yM + 3, xM + 7)
    isMap[xM + 7][yM + 3] = true;

    draw_square(yM + 3, xM + 8)
    isMap[xM + 8][yM + 3] = true;

    draw_square(yM + 3, xM + 9)
    isMap[xM + 9][yM + 3] = true;

    draw_square(yM + 4, xM)
    isMap[xM][yM + 4] = true;

    draw_square(yM + 4, xM + 1)
    isMap[xM + 1][yM + 4] = true;

    draw_square(yM + 4, xM + 9)
    isMap[xM + 9][yM + 4] = true;

    draw_square(yM + 5, xM)
    isMap[xM][yM + 5] = true;

    draw_square(yM + 5, xM + 8)
    isMap[xM + 8][yM + 5] = true;

    draw_square(yM + 5, xM + 9)
    isMap[xM + 9][yM + 5] = true;

    draw_square(yM + 6, xM + 1)
    isMap[xM + 1][yM + 6] = true;

    draw_square(yM + 6, xM + 2)
    isMap[xM + 2][yM + 6] = true;

    draw_square(yM + 6, xM)
    isMap[xM][yM + 6] = true;

    draw_square(yM + 6, xM + 7)
    isMap[xM + 7][yM + 6] = true;

    draw_square(yM + 6, xM + 8)
    isMap[xM + 8][yM + 6] = true;

    draw_square(yM + 7, xM + 2)
    isMap[xM + 2][yM + 7] = true;

    draw_square(yM + 7, xM + 3)
    isMap[xM + 3][yM + 7] = true;

    draw_square(yM + 7, xM + 6)
    isMap[xM + 6][yM + 7] = true;

    draw_square(yM + 7, xM + 7)
    isMap[xM + 7][yM + 7] = true;

    draw_square(yM + 8, xM + 3)
    isMap[xM + 3][yM + 8] = true;

    draw_square(yM + 8, xM + 4)
    isMap[xM + 4][yM + 8] = true;

    draw_square(yM + 8, xM + 6)
    isMap[xM + 6][yM + 8] = true;

    draw_square(yM + 9, xM + 5)
    isMap[xM + 5][yM + 9] = true;

    draw_square(yM + 9, xM + 4)
    isMap[xM + 4][yM + 9] = true;

    draw_square(yM + 9, xM + 6)
    isMap[xM + 6][yM + 9] = true;
